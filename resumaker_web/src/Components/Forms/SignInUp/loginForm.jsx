          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <div className="password-input-container">
                ...
                >
                  {showPassword ? (
                    <img className="password-icon hide-password" src={eyeClosedIcon} alt="Hide password" />
                  ) : (
                    <img className="password-icon show-password" src={eyeOpenIcon} alt="Show password" />
                  )}
                </button>
              </div>
            </div>
